...
int calculaPromedioDeDosEnterosPorReferencia(int primerEntero,int segundoEntero, float * punteroAlPromedio);
...
//	notaDos = pedirDatoNumericoInt();
	...
	printf("La direccion de memoria en el main es: %p", &promedioDeNotaPorPuntero);
	calculaPromedioDeDosEnterosPorReferencia(notaUno,3,&promedioDeNotaPorPuntero);
	printf("notaUno es: %d\n", notaUno);
